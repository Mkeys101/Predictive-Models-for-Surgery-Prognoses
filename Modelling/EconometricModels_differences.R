...
### Groin Hernia Repair 
groin_regression = lm(EQ5D_Index_Diff ~ PreOp_Q_Activity + PreOp_Q_Anxiety + 
...
### Groin Hernia Repair 
groin_fe_pa_regression = plm(EQ5D_Index_Diff ~ PreOp_Q_Activity + PreOp_Q_Anxiety + 
                             PreOp_Q_Discomfort +  PreOp_Q_Disability + PreOp_Q_EQ5D_Index + PreOp_Q_Mobility + PreOp_Q_SelfCare +           
                             PreOp_Q_Assisted + PreOp_Q_Assisted_By + Age_Band_30_to_39 + Age_Band_50_to_59 +
                             Age_Band_60_to_69 + Age_Band_70_to_79 + Age_Band_80_to_89 + 
                             Groin_Hernia_Participation_Rate + Groin_Hernia_Linkage_Rate + Groin_Hernia_Issue_Rate + 
...
### Groin Hernia Repair 
groin_fe_pr_regression = plm(EQ5D_Index_Diff ~ PreOp_Q_Activity + PreOp_Q_Anxiety + 
                             PreOp_Q_Discomfort +  PreOp_Q_Disability + PreOp_Q_EQ5D_Index + PreOp_Q_Mobility + PreOp_Q_SelfCare +           
                             PreOp_Q_Assisted + PreOp_Q_Assisted_By + Age_Band_30_to_39 + Age_Band_50_to_59 +
                             Age_Band_60_to_69 + Age_Band_70_to_79 + Age_Band_80_to_89 + 
                             Groin_Hernia_Participation_Rate + Groin_Hernia_Linkage_Rate + Groin_Hernia_Issue_Rate + 
...
### Groin Hernia Repair 
groin_fe_prpa_regression = plm(EQ5D_Index_Diff ~ PreOp_Q_Activity + PreOp_Q_Anxiety + 
                               PreOp_Q_Discomfort +  PreOp_Q_Disability + PreOp_Q_EQ5D_Index + PreOp_Q_Mobility + PreOp_Q_SelfCare +           
                               PreOp_Q_Assisted + PreOp_Q_Assisted_By + Age_Band_30_to_39 + Age_Band_50_to_59 +
                               Age_Band_60_to_69 + Age_Band_70_to_79 + Age_Band_80_to_89 + 
                               Groin_Hernia_Participation_Rate + Groin_Hernia_Linkage_Rate + Groin_Hernia_Issue_Rate + 
